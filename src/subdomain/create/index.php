...
$subdomainLimitsCheck = check_subdomain_limits($apiKey, $conn);
if (!$subdomainLimitsCheck['success']) {
    echo json_encode(['success' => false, 'result' => $subdomainLimitsCheck['result']]);
    exit();
}
